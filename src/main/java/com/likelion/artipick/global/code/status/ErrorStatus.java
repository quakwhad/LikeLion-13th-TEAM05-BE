...
public enum ErrorStatus implements BaseErrorCode {
    ...
    CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "CATEGORY4048", "카테고리를 찾을 수 없습니다."),
    RECOMMENDATION_NOT_FOUND(HttpStatus.NOT_FOUND, "RECOMMENDATION4049", "추천 데이터를 찾을 수 없습니다."),
